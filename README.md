...
下面展示标准电子报告与手机拍照报告的实际处理结果。每个案例同时说明已遮挡的信息、保留下来的医疗内容和仍需人工检查的风险。
...
这份北京协和医院检验报告中可见患者姓名、部分单号、申请科室、申请医生和审核医生。处理结果遮挡了患者姓名和单号，检验项目与结果仍然可读；人工检查发现申请科室被一并遮挡，因此仍需复核误遮区域。
